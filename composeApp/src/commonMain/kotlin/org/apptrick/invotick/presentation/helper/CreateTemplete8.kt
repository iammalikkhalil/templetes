...
import invotick.composeapp.generated.resources.Rectangle40359
import invotick.composeapp.generated.resources.Res
import invotick.composeapp.generated.resources.fi_12273641
...
fun createTemplate8(
    ...
    return InvoiceTemplateConfig(
        ...
        style = invoiceTemp8TextStyles(),
        visibility = InvoiceVisibilities(),
        data = sampleData1(),
        fontFamily = fontFamily,
        templateType = TemplateType.TEMPLATE_8,
        images = images,
    )
}


fun template8ImageRes(): InvoiceImageRes = InvoiceImageRes(
    headerBackground = Res.drawable.Rectangle40359,
    background = Res.drawable.fi_12273641,
    signature = Res.drawable.signature,
    stamp = Res.drawable.stamp,
)

fun invoiceTemp8TextStyles(): InvoiceTextStyles = InvoiceTextStyles(
    invoiceTitle = defaultTextStyle(120f, FontWeight.ExtraBold),
)